  ...
  <div class="home">
    <div id="nav">
      ...
      <b-row>
        ...
        <b-col cols="10">
          <b-row class="mb-4" dir="rtl" align="center">
            <b-col> </b-col>
          </b-row>

          <b-row dir="rtl">
            <b-col class="grid col-xl-4 col-lg-6 col-sm-12 col-12">
                  ...
                  <div>
                    <div>
                      <b-row align="right">
                        ...
                        <b-col class="p-0" cols="3">
                          <b> {{ numberWithCommas(sekeGhadimPrice) }} </b>
                        </b-col>
                      </b-row>
                      <br />
                      <br />
                  ...
                  <div>
                    <div>
                      <b-row align="right">
                        ...
                        <b-col class="p-0" cols="3">
                          <b> {{ numberWithCommas(sekeGeramiPrice) }} </b>
                        </b-col>
                      </b-row>
                      <br />
                      <br />
                  ...
                  <div>
                    <div>
                      <b-row align="right">
                        ...
                        <b-col class="p-0" cols="3">
                          <b> {{ numberWithCommas(geramTalaPrice) }} </b>
                        </b-col>
                      </b-row>
                      <br />
                    </div>
                  ...
                  <div>
                    <div>
                      <b-row align="right">
                        ...
                        <b-col class="p-0" cols="3">
                          <b> {{ numberWithCommas(gram24TalaPrice) }} </b>
                        </b-col>
                      </b-row>
                      <br />
                    </div>
                  ...
                  <div>
                    <div>
                      <b-row align="right">
                        ...
                        <b-col class="p-0" cols="3">
                          <b> {{ numberWithCommas(mesghalRiyal) }} </b>
                        </b-col>
                      </b-row>
                      <br />
                    </div>
                  ...
                  <div>
                    <div>
                      <b-row align="right">
                        ...
                        <b-col class="p-0" cols="3">
                          <b> {{ numberWithCommas(sekeRiyal) }} </b>
                        </b-col>
                      </b-row>
                      <br />
                    </div>
            ...
            <b-col class="grid col-xl-4 col-lg-6 col-12">
              <b-card-group>
                      ...
                      <div>
                        <div>
                          <b-row align="right">
                            ...
                            <b-col class="p-0" cols="3">
                              <b> {{ numberWithCommas(sekeMellatPrice) }} </b>
                            </b-col>
                          </b-row>
                          <br />
                        </div>
                      ...
                      <div>
                        <div>
                          <b-row align="right">
                            ...
                            <b-col class="p-0" cols="3">
                              <b> {{ numberWithCommas(sekeSamanPrice) }} </b>
                            </b-col>
                          </b-row>
                          <br />
                        </div>
                      ...
                      <div>
                        <div>
                          <b-row align="right">
                            ...
                            <b-col class="p-0" cols="3">
                              <b> {{ numberWithCommas(sekeAyandehPrice) }} </b>
                            </b-col>
                          </b-row>
                          <br />
                        </div>
                        ...
                        <div>
                          <b-row align="right">
                            ...
                            <b-col class="pr-0" cols="3">
                              <!-- <div v-if="HobabAyandehCoinFree > 0">
                                <p style="color: green">
                                  {{ numberWithCommas(HobabAyandehCoinFree) }}%
                                </p>
                              </div>
                              <div v-else>
                                <p style="color: red">
                        ...
                        <div>
                          <b-row align="right">
                            ...
                            <b-col class="p-0" cols="3">
                              <!-- <div v-if="HobabAyandehCoinSekeRiyal > 0">
                                <p style="color: green">
                                  {{
                                    numberWithCommas(HobabAyandehCoinSekeRiyal)
                                  }}%
                                </p>
                              </div>
                              <div v-else>
            ...
            <b-col class="grid col-xl-4 col-12">
              <b-card-group dir="rtl">
                <b-card style="border-radius: 20px" class="shadow">
                  <template #header>
                    <div style="text-align: center">
                        ...
                        <div>
                          <div>
                            <b-row align="right">
                              ...
                              <b-col class="pr-0" cols="3">
                                <div v-if="def_talaLotusPrice > 0">
                                  <p style="color: green">
                                    {{ numberWithCommas(def_talaLotusPrice) }}%
                                  </p>
                                </div>
                                <div v-else>
                                  <p style="color: red">
                        ...
                        <div>
                          <div>
                            <b-row align="right">
                              ...
                              <b-col class="p-0" cols="3">
                                <div v-if="def_talaAyarPrice > 0">
                                  <p style="color: green">
                                    {{ numberWithCommas(def_talaAyarPrice) }}%
                                  </p>
                                </div>
                                <div v-else>
                                  <p style="color: red">
                        ...
                        <div>
                          <div>
                            <b-row align="right">
                              ...
                              <b-col class="pr-0" cols="3">
                                <div v-if="def_talaZarPrice > 0">
                                  <p style="color: green">
                                    {{ numberWithCommas(def_talaZarPrice) }}%
                                  </p>
                                </div>
                                <div v-else>
                                  <p style="color: red">
                        ...
                        <div>
                          <div>
                            <b-row align="right">
                              ...
                              <b-col class="pr-0" cols="3">
                                <div v-if="def_talaGoharPrice > 0">
                                  <p style="color: green">
                                    {{ numberWithCommas(def_talaGoharPrice) }}%
                                  </p>
                                </div>
                                <div v-else>
                                  <p style="color: red">
                        ...
                        <div>
                          <div>
                            <b-row align="right">
                              ...
                              <b-col class="p-0" cols="3">
                                <b>
                                  {{ numberWithCommas(talaKahrobaPriceOpen) }}
                                </b>
                              </b-col>
                            </b-row>
                            <br />
                          ...
                          <div>
                            <b-row align="right">
                              ...
                              <b-col class="p-0" cols="3">
                                <p style="color: #742b6c">
                                  {{
                                    numberWithCommas(talaKahrobaPricePrevious)
                                  }}
                                </p>
                              </b-col>
                            </b-row>
...
export default {
  ...
  data() {
    return {
      ...
      sekeGeramiPrice: 0,
      sekeRefahPrice: 0,
      HobabRefahCoinFree: 0,
      HobabRefahCoinSekeRiyal: 0,
      sekeSaderatPrice: 0,
      HobabSaderatCoinFree: 0,
      HobabSaderatCoinSekeRiyal: 0,
      sekeMellatPrice: 0,
      ...
      sekeAyandehPrice: 0,
      HobabAyandehCoinFree: 0,
      HobabAyandehCoinSekeRiyal: 0,

      HobabSamanCoinFree: 0,
      HobabSamanCoinSekeRiyal: 0,

      talaLotusPriceOpen: 0,
      HobabTalaLotusSeke: 0,
      HobabTalaLotusNav: 0,
      talaAyarPriceOpen: 0,
      HobabTalaAyarSeke: 0,
      HobabTalaAyarNav: 0,
      ...
      talaGoharPriceOpen: 0,

      talaKahrobaPriceOpen: 0,
      HobabTalaKahrobaSeke: 0,
      HobabTalaKahrobaNav: 0,

      HobabTalaGoharSeke: 0,
      HobabTalaGoharNav: 0,

      talaLotusPricePrevious: 0,
      talaAyarPricePrevious: 0,
      talaZarPricePrevious: 0,
      ...
      showHobabMelat: false,
      showHobabSaman: false,
      showHobabLoutos: false,
      showHobabEyar: false,
      showHobabZar: false,
      showHobabGohar: false,
      showHobabmesghal: false,
      showHobabSeke: false,
      showHobabGhadim: false,
      showHobabNim: false,
      showHobabRob: false,
      showHobabGerami: false,
      //date
      today: 0,
    };
  },
    ...
    async btcTrkAPICall() {
      await axios
        ...
        .then((response) => {
          ...
          this.talaKahrobaPriceOpen = response.data.Data.talaKahrobaPriceOpen;
          ...
          this.HobabAyandehCoinFree = this.decimalAdjust(
            "round",
            this.decimalAdjust(
              "round",
              response.data.Data.HobabAyandehCoinFree,
              -4
            ) * 100,
            -4
          );
          ...
          this.HobabAyandehCoinSekeRiyal = this.decimalAdjust(
            "round",
            this.decimalAdjust(
              "round",
              response.data.Data.HobabAyandehCoinSekeRiyal,
              -4
            ) * 100,
            -4
          );
          ...
          this.def_talaZarPrice = this.decimalAdjust(
            "round",
            this.decimalAdjust("round", this.def_talaZarPrice1, -4) * 100,
            -4
          );
          ...
          this.def_talaLotusPrice1 =
            this.talaLotusPriceOpen / this.talaLotusPricePrevious - 1;

          this.def_talaLotusPrice = this.decimalAdjust(
            "round",
            this.decimalAdjust("round", this.def_talaLotusPrice1, -4) * 100,
            -4
          );
          ...
          this.def_talaAyarPrice = this.decimalAdjust(
            "round",
            this.decimalAdjust("round", this.def_talaAyarPrice1, -4) * 100,
            -4
          );
          ...
          this.def_talaGoharPrice1 =
            this.talaGoharPriceOpen / this.talaGoharPricePrevious - 1;

          this.def_talaGoharPrice = this.decimalAdjust(
            "round",
            this.decimalAdjust("round", this.def_talaGoharPrice1, -4) * 100,
            -4
          );
          ...
          this.HobabTalaKahrobaNav = this.decimalAdjust(
            "round",
            this.decimalAdjust(
              "round",
              response.data.Data.HobabTalaKahrobaNav,
              -4
            ) * 100,
            -4
          );
